    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if (validate_password($obj->password, $good_hash)) {
            ...
            if ($obj->applicationid == '0') {
                $filterstr = "select *  from application WHERE is_assignto_fos='1' and am_accaptance='1' and fosid = '" . $row['agencymanagerid'] . "' and fos_completed='0' and runsheet='0' ORDER BY STR_TO_DATE(PTP_Date,'%d-%m-%Y') ASC";
            } else {
