...
$sql1 = "SELECT * FROM `colleted_application`  where   am_accaptance IN (2,3) and STR_TO_DATE(strEntryDate,'%d-%m-%Y %H:%i:%s') >= STR_TO_DATE('01-08-2019','%d-%m-%Y') and STR_TO_DATE(strEntryDate,'%d-%m-%Y %H:%i:%s') <= STR_TO_DATE('31-08-2019','%d-%m-%Y')";
...
$filename = 'return_withdraw_cases_082019.xls';
