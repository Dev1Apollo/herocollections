...
include('../config.php');
  ...
  $strLocationID = '';
    ...
    $sql1 = "SELECT * FROM `application` where locationid in(".$strLocationID.") and fos_completed='1' and fos_completed_status='1' and agencysupervisorid='".$_SESSION['agencysupervisorid']."' ";
