...
//ptprescheduled=3
    ...
    $filterstr = "SELECT * FROM `application` where locationid in(" . $strLocationID . ") and  fos_completed='2' and fos_completed_status='3' ";
    $countstr = "SELECT count(*) as TotalRow FROM  `application` where locationid in(" . $strLocationID . ") and  fos_completed='2' and fos_completed_status='3'  ";
        ...
        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="tableC">
            ...
            <thead class="tbg">
                <tr>
                    ...
                    <th class="none">Contact_Detail ref2</th>
