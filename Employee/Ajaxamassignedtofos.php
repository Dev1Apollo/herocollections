...
//        $where.=" and STATE  = '" . $state['stateName'] . "' and location ='". $location['locationName'] . "'";
    ...
    $filterstr = "SELECT * FROM `application`  " . $where . " and  is_assignto_am='1' and agencyid='" . $useragency['agencyname'] . "' and is_assignto_as='1' and am_accaptance ='1' and fosid > 0    ";
    $countstr = "SELECT count(*) as TotalRow FROM  `application` " . $where . " and  is_assignto_am='1' and agencyid='" . $useragency['agencyname'] . "' and am_accaptance ='1' and is_assignto_as='1'  and fosid > 0 ";
