...
//                                }
                            ...
                            $data = array(
                                ...
                                "action_name" => 'Central Team Reassign Return Case',
                                "strEntryDate" => date('d-m-Y H:i:s'),
                                "strIP" => $_SERVER['REMOTE_ADDR']
                            );
                            $dealer_res = $connect->insertrecord($dbconn, 'applicationlog', $data);

                            $insertString = $insertString  . " Time_Slot" . "=" . "'" . $PTPTimeSlot . "'".  ",PTP_Amount" ."=" . "'". $PTPAmount . "'" . ",PTP_Date " . "=" . "'" . $DateInInRow . "'" . ",assign_as_datetime" . " = '" . date('d-m-Y H:i:s') . "',am_accaptance" . " = " . "1" . ",agency = " . "'" . $agencynameIdInRow . "' " . ",fosid = 0 ,is_assignto_fos = 0,fos_completed_status=0,agencyid = " . $AgencyidInRow . $Whwere = " where  App_Id =" . "'" . $LANNUMBERInRow . "' and am_accaptance = 3 ";
