...
include('../config.php');
 ...
 $strLocationID = '';
    ...
    $sql1 = "SELECT * FROM `application` where locationid in(".$strLocationID.") and fos_completed='1' and fos_completed_status='4' and agencysupervisorid='".$_SESSION['agencysupervisorid']."'";

$result1 = mysqli_query($dbconn, $sql1);
//$date=date('d-m-Y');

$filename = 'ascustomernotavailabel.xls';
