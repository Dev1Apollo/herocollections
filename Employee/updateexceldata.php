...
<html lang="en">
    <head>
        ...
        <title> <?php echo $ProjectName ?> | Update Allocation</title>
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption font-red-sunglo">
                                    ...
                                    <span class="caption-subject bold uppercase">Update Allocation</span>
                                </div>
                            </div>
...
<!--                                                    <div class="form-group">
        ...
        <script type="text/javascript">
            ...
            $('#frmparameter').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url; ?>Employee/updateexcelquerydata.php',
