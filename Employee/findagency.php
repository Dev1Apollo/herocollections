...
// echo "select * from agencymanager  where  istatus='1' and isDelete='0' and agencymanagerid in (".$agencymanagerid.") and type='Agency Manager'  ";
// exit;
  $result1=mysqli_query($dbconn,"select * from agencymanager  where  istatus='1' and isDelete='0' and agencymanagerid in (".$agencymanagerid.") and type='Agency Manager' ");
$data='<select name="agencymanager" id="agencymanager" class="form-control"  required  >
