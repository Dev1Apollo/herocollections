...
//address not trasable =5
    ...
    $filterstr = "SELECT * FROM `application` where locationid in(".$strLocationID.") and fos_completed='1' and fos_completed_status='5' and agencysupervisorid='".$_SESSION['agencysupervisorid']."''  ";
    $countstr = "SELECT count(*) as TotalRow FROM  `application` where locationid in(".$strLocationID.") and fos_completed='1' and fos_completed_status='5' and agencysupervisorid='".$_SESSION['agencysupervisorid']."'  ";
