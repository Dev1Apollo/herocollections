...
<html lang="en">
    <head>
        ...
        <title> <?php echo $ProjectName ?> | Update Payment Collected</title>
    ...
    <body class="page-container-bg-solid page-boxed">
            ...
            <div class="page-content">
                <div class="container">                    
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span>Update Payment Collected</span>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase">Update Payment Collected</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="Updatepaymentcollected" name="action" id="action">
                                                <div class="form-body">
                                                    <div class=" col-md-12">
        ...
        <script type="text/javascript">
            ...
            function checkclose() {
                window.location.href = 'updatepaymentcollected.php';
            }
            ...
            $('#frmparameter').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url; ?>Employee/updatepaymentcollectedquerydata.php',
