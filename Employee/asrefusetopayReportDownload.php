...
include('../config.php');
   ...
   $sql1 = "SELECT * FROM `application` where locationid in(".$strLocationID.") and  fos_completed='1' and fos_completed_status='2' and agencysupervisorid='".$_SESSION['agencysupervisorid']."' ";
