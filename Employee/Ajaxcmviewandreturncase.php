...
//        $state = mysqli_fetch_array(mysqli_query($dbconn, "SELECT * FROM `state`  where isDelete='0'  and  istatus='1' and stateId='" . $_REQUEST['State'] . "' order by  stateName asc"));
//
//        $where.=" and  STATE = '" . $state['stateName'] . "'";
            $where.=" and  stateid = '" . $_REQUEST['State'] . "'";
        }



        $filterstr = "SELECT * FROM `application` " . $where . " and  is_assignto_am='1' and am_accaptance='3'  ";
        $countstr = "SELECT count(*) as TotalRow FROM  `application` " . $where . " and  is_assignto_am='1' and am_accaptance='3'  ";
    }
...
// echo $filterstr;
    ...
    if (mysqli_num_rows($resultfilter) > 0) {
        ...
        <form  role="form"  method="POST"  action="" name="frmparameterrr"  id="frmparameterrr" enctype="multipart/form-data">
            <input type="hidden" value="cmreassignreturncase" name="action" id="action">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="btn blue " type="submit" id="Btnmybtn"  valuse="Submit" name="submit">      
        ...
        <script type="text/javascript">
            ...
            function checkclose() {
                window.location.href = '<?php echo $web_url; ?>Employee/cmviewandreturncase.php';
            }
