...
$result = mysqli_query($dbconn, "SELECT * FROM `agncylocation` WHERE `agencyid`='" . $_REQUEST['token'] . "'");
                                ...
                                <div class="portlet light ">
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                            <input type="hidden" value="cmagancystatedistrict" name="action" id="action">
                                            <input type="hidden" value="<?php echo $_REQUEST['token'] ?>" name="agencyid" id="agencyid">
                                            <div class="form-body">
                                                <div class="row">
...
<?php include_once './footer.php'; ?>
    ...
    <script type="text/javascript">
        ...
        function getlocation() {
            ...
            var sId = $('#State').val();
            var urlp = '<?php echo $web_url; ?>Employee/find-cm-location.php?did=' + district + '&sId=' + sId + '&agencyid=' +agencyid;
            $.ajax({
                type: 'POST',
                url: urlp,
                success: function (data) {
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == 1)
                    {
                        ...
                        window.location.href = '<?php echo $web_url; ?>Employee/cm-agencystatedistrict.php?token=' + agencyid;
                    }
                }
        ...
        var agencyid = $('#agencyid').val();
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>Employee/Ajax-cm-agencystatedistrict.php",
...
function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url;?>admin/Ajaxagencystatedistrict.php",
