...
$useragency=  mysqli_fetch_array(mysqli_query($dbconn, "SELECT * FROM `agencymanager` WHERE agencymanagerid ='".$_SESSION['agencymanagerid']."' "));
    $filterstr = "SELECT * FROM `application`  where  is_assignto_am='1' and agencyid='".$useragency['agencyname']."' and am_accaptance ='3'";
    $countstr = "SELECT count(*) as TotalRow FROM  `application` where  is_assignto_am='1' and agencyid='".$useragency['agencyname']."' and am_accaptance ='3' ";
