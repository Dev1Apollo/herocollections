...
<?php
   ...
   $strLocationID = '0';
    ...
    $sql1 = "SELECT * FROM `application` where locationid in(".$strLocationID.") and fos_completed='2' and fos_completed_status='3' and agencyid='" . $useragency['agencyname'] . "' ";
    

$result1 = mysqli_query($dbconn, $sql1);
//$date=date('d-m-Y');

$filename = 'amptprescheduled.xls';
