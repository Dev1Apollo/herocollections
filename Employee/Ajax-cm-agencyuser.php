...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `agencymanager`  " . $where . " and isDelete='0'  and  istatus='1' order by  agencymanagerid desc";
    $countstr = "SELECT count(*) as TotalRow FROM `agencymanager`  " . $where . " and isDelete='0' and  istatus='1' ";
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <div class="form-group form-md-line-input">
                                <!--<a  class="btn blue" href="<?php echo $web_url; ?>admin/agencymanagerChangePassword.php?token=<?php echo $rowfilter['agencymanagerid']; ?>" title="Change Password"><i class="fa-key fa"></i></a>-->
                                <a  class="btn blue" href="<?php echo $web_url; ?>Employee/Edit-cm-agencyuser.php?token=<?php echo $rowfilter['agencymanagerid']; ?>" title="Edit"><i class="fa fa-edit iconshowFirst"></i></i></a>
                                ...
                                <a  class="btn blue" href="<?php echo $web_url; ?>Employee/cm-agencyuserlocationassign.php?token=<?php echo $rowfilter['agencymanagerid']; ?>" title="Edit"><i class="fa fa-plus iconshowFirst"></i></i></a>
                            </div>
                        </td>
