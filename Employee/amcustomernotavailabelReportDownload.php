...
<?php
   ...
   $sql1 = "SELECT * FROM `application` where locationid in(".$strLocationID.") and fos_completed='1' and fos_completed_status='4' and agencyid='" . $useragency['agencyname'] . "' ";
...
$filename = 'amcustomernotavailabel.xls';
