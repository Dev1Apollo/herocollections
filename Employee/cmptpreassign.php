...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | PTP RE-Assigned</title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of PTP RE-Assigned</span>
                                        </div>
                                    </div>
...
<!--                                                    </div>
        ...
        <script type="text/javascript">
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url;?>Employee/Ajaxcmptpreassign.php", 
         ...
         <script type="text/javascript">
            ...
            function checkb4submit()
            {
                ...
                var strURL = "cmptpreassignReportDownload.php?State=" + State + "&location=" + location;
                //alert(strURL);           
