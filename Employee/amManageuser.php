...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Manage User</title>
                        ...
                        <div class="page-content-inner">
                            <div class="portlet light ">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <a href="<?php echo $web_url;?>Employee/Addamagencymanager.php" class="btn blue" style="float: right;" title="Add Central Manager">ADD Agency User</a>
                                </div>
          ...
          <script type="text/javascript">
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url;?>Employee/AjaxamManageuser.php",
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({    
                    type: "POST",
                    url: "<?php echo $web_url;?>Employee/AjaxamManageuser.php",
                    data: {action: 'ListUser', Page: Page, Location: Location, Search_Txt: Search_Txt,Type:Type},
                    success: function (msg) {
