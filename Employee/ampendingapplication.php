    ...
    <body class="page-container-bg-solid page-boxed">
                                    ...
                                    <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <!--                                                <div class="form-group  col-md-4">
                                                                                                    <label for="form_control_1">Select Agency supervisor</label>
                                                                                                     <div id="agencyid">
                                                ...
                                                $results = mysqli_query($dbconn, $querys);
                                                echo '<select class="form-control" name="agencysupervisor" id="agencysupervisor" required=""  >';
                                                echo "<option value='' >Select Agency supervisor</option>";
                                                while ($rows = mysqli_fetch_array($results)) {
                                                    echo "<option value='" . $rows['agencymanagerid'] . "'>" . $rows['agencyname'] . "</option>";
                                                }
                                                echo "</select>";
                                                ?>
                                                                                                </div>
        ...
        <script type="text/javascript">
            ...
            function getlocation() {
                var State = $('#State').val();
                var urlp = '<?php echo $web_url; ?>Employee/findlocationagencysupervisor.php?sid=' + State;
                $.ajax({
                    type: 'POST',
                    url: urlp,
            ...
            function getagency() {
                ...
                var urlp = '<?php echo $web_url; ?>Employee/findagencysupervisor.php?locationid=' + location;
                $.ajax({
                    type: 'POST',
                    url: urlp,
                    success: function (data) {
        ...
        <script type="text/javascript">
            function PageLoadData(Page) {
                ...
                var State = $('#State').val();
                var location = $('#location').val();
                var agencysupervisor = $('#agencysupervisor').val();
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>Employee/Ajaxampendingapplication.php",
                    data: {action: 'ListUser', Page: Page, State: State, location: location, agencysupervisor: agencysupervisor},
