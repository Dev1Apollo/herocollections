...
if ($_REQUEST['location'] != NULL || $_REQUEST['State'] != NULL) {
    ...
    $sql1 = "SELECT * FROM `application` where locationid in(" . $strLocationID . ") and fos_completed='1' and fos_completed_status='1' and agencyid='" . $useragency['agencyname'] . "'";
}

$result1 = mysqli_query($dbconn, $sql1);
//$date=date('d-m-Y');

$filename = 'ampickupdone.xls';
