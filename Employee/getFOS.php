...
if (count($obj)>0) {
   ...
   // print_r($data);
    ...
    if($data->hash===$strHash){
        $filterstr ="SELECT agencymanagerid,employeename,address,loginId,password,salt,strEntryDate,strIP,istatus,isDelete 	 FROM `agencymanager` where type='FOS' and istatus=1 and isDelete=0";
