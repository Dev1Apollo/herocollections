...
//pick up done =1
    ...
    $filterstr = "SELECT * FROM `application` where locationid in(".$strLocationID.") and fos_completed='1' and fos_completed_status='1' and agencysupervisorid='".$_SESSION['agencysupervisorid']."' ";
    $countstr = "SELECT count(*) as TotalRow FROM  `application` where locationid in(".$strLocationID.") and fos_completed='1' and fos_completed_status='1' and agencysupervisorid='".$_SESSION['agencysupervisorid']."'   ";
