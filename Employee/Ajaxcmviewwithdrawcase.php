...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `application` " . $where . " and is_assignto_am='1' and am_accaptance='2' ";
    $countstr = "SELECT count(*) as TotalRow FROM  `application` " . $where . " is_assignto_am='1' and am_accaptance='2'";
    ...
    if (mysqli_num_rows($resultfilter) > 0) {
        ...
        <script type="text/javascript">
            function checkclose() {
                window.location.href = '<?php echo $web_url; ?>Employee/cmviewwithdrawcase.php';
            }
