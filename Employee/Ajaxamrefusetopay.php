...
//refuse to pay=2
    ...
    $filterstr = "SELECT * FROM `application` where locationid in(".$strLocationID.") and fos_completed='1' and fos_completed_status='2' and agencyid='" . $useragency['agencyname'] . "' ";
    $countstr = "SELECT count(*) as TotalRow FROM  `application` where locationid in(".$strLocationID.") and fos_completed='1' and fos_completed_status='2' and agencyid='" . $useragency['agencyname'] . "'  ";
