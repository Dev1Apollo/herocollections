                            ...
                            <div class="col-md-12">
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        ...
                                        <a href="<?php echo $web_url; ?>Employee/Add-cm-agencyuser.php" class="btn blue" style="float: right;" title="Add Central Manager">ADD Agency User</a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <script type="text/javascript">
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url; ?>Employee/Ajax-cm-agencyuser.php",
