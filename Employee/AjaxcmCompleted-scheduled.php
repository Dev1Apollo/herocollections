...
//    }
    ...
    $filterstr = "SELECT * FROM `application`  " . $where . " and   fos_completed_status = '1' and locationid in(" . $strLocationID . ")  ";
    $countstr = "SELECT count(*) as TotalRow FROM  `application`  " . $where . " and   fos_completed_status = '1' and locationid in(" . $strLocationID . ")   ";
