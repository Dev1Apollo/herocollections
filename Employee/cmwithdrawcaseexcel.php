...
<html lang="en">
    <head>
        ...
        <title> <?php echo $ProjectName ?> | Add Upload Application</title>
    ...
    <body class="page-container-bg-solid page-boxed">
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption font-red-sunglo">
                                    ...
                                    <span class="caption-subject bold uppercase">Withdraw Upload Application</span>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            $('#frmparameter').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url; ?>Employee/withderowcaseexcel.php',
                    ...
                    success: function (response) {
                      ...
                      //  alert(response);
                        if (response == 0)
                        {
                            ...
                            window.location.href = 'cmwithdrawcaseexcel.php';
                        } else {
                            $('#loading').css("display", "none");
