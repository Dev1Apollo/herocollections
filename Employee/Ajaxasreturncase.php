...
//is_assignto_fos='0'
    ...
    $countstr = "SELECT count(*) as TotalRow FROM  `application` " . $where . " and  customer_city_id in(" . $strLocationID . ") and is_assignto_as='1' and   agencyid='" . $useragency['agencyname'] . "' and am_accaptance = '1' and  fos_completed_status NOT IN ('1','10','11','12','13','14','15') ";
...
// echo $filterstr;
    ...
    if (mysqli_num_rows($resultfilter) > 0) {
        ...
        <form  role="form"  method="POST"  action="" name="frmparameterrr"  id="frmparameterrr" enctype="multipart/form-data">
            <input type="hidden" value="asreturncases" name="action" id="action">
            <input class="btn blue margin-top-20 " type="submit" id="Btnmybtn"  value="Return Case" name="submit">      
            ...
            $('#frmparameterrr').submit(function (e) {
                ...
                $.ajax({
                   ...
                   // alert(response);
                        ...
                        //window.location.href = '<?php echo $web_url; ?>Employee/asreturncase.php';
                    }
