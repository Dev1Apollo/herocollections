...
$sql1 = "SELECT * FROM `application` " . $where . " and   is_assignto_as='1'  and is_assignto_fos='1' and fos_completed='0' and  agencyid='" . $useragency['agencyname'] . "' ";
