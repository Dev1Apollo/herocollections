...
include('../config.php');
 ...
 $strLocationID = '0';
    ...
    $sql1 = "SELECT * FROM `application` where locationid in(".$strLocationID.") and fos_completed='1' and fos_completed_status='5' and agencysupervisorid='".$_SESSION['agencysupervisorid']."''  ";

$result1 = mysqli_query($dbconn, $sql1);
//$date=date('d-m-Y');

$filename = 'asaddressnottracable.xls';
