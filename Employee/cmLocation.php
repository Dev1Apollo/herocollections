                                    ...
                                    <div class="portlet light ">
                                        ...
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="AddcmLocation" name="action" id="action">
                                                <div class="form-body">
           ...
           function finddistrict()
            ...
            function setEditdata(id)
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url;?>Employee/querydata.php',
                    data: {action: "GetcmLocation", ID: id},
                    success: function (response) {
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url;?>Employee/AjaxcmLocation.php",
