...
$sql1 = "SELECT *,(select status from fosstatusdrropdown where fosstatusdrropdown.fosstatusdrropdownid = application.fos_completed_status) as status FROM `application`  " . $where . " and   fos_completed_status='1' and locationid in(" . $strLocationID . ") ";
