...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Refuse To Pay</title>
    ...
    <body class="page-container-bg-solid page-boxed">
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Refuse To Pay</span>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url;?>Employee/Ajaxamrefusetopay.php",
...
//            }
         ...
         <script type="text/javascript">
            ...
            function checkb4submit()
            {
                ...
                var strURL = "amrefusetopayReportDownload.php?State=" + State + "&location=" + location;
                //alert(strURL);           
