...
if ($_POST['action'] == 'ListUser') {
    ...
    if ($_REQUEST['location'] != NULL && isset($_REQUEST['location'])) {
       ...
       // $where.=" and  locationid = '" . $_REQUEST['location'] . "'";
        ...
        $filterstr = "SELECT * FROM `application` " . $where . " and  is_assignto_am='1' and am_accaptance IN ('1','0') and fos_completed_status !='1'  order by  applicationid asc";
        $countstr = "SELECT count(*) as TotalRow FROM  `application` " . $where . " and is_assignto_am='1' and am_accaptance='1'  and fos_completed_status !='1'  ";
    }
...
// echo $filterstr;
    ...
    if (mysqli_num_rows($resultfilter) > 0) {
        ...
        <form  role="form"  method="POST"  action="" name="frmparameterrr"  id="frmparameterrr" enctype="multipart/form-data">
            <input type="hidden" value="cmwithdrawcase" name="action" id="action">
            <div class="form-group col-md-4">
                <input class="btn blue " type="submit" id="Btnmybtn"  value="Withdraw Case" name="submit">             
            </div>
