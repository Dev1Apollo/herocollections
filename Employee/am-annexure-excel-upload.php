...
<html lang="en">
    <head>
        ...
        <title> <?php echo $ProjectName ?> |  Upload Annexure </title>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase">Upload Annexure</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="uploadannexuredata" name="action" id="action">
...
//                                            ?>
        ...
        <script type="text/javascript">
            ...
            function checkclose() {
                window.location.href = 'am-annexure-excel-upload.php';
            }
            ...
            $('#frmparameter').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url; ?>Employee/annexure-excel-QueryData.php',
