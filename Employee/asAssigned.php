...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Assigned</title>
    ...
    <body class="page-container-bg-solid page-boxed">
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase">List of View Assigned Case</span>
                                    </div>
                                </div>
                                    ...
                                    <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <!--                                                <div class="form-group  col-md-4">
                                                                                                    <label for="form_control_1">Select FOS</label>
                                                                                                     <div id="agencyid">
                                                ...
                                                $results = mysqli_query($dbconn, $querys);
                                                echo '<select class="form-control" name="fos" id="fos" required=""  >';
        ...
        <script type="text/javascript">
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>Employee/AjaxasAssigned.php",
        ...
        <script type="text/javascript">
            ...
            function checkb4submit()
            {
                ...
                var strURL = "asAssignedReportDownload.php?State=" + State + "&location=" + location;
                //alert(strURL);           
