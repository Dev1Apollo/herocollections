...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Central Manager Change Password </title>
    ...
    <body class="page-container-bg-solid page-boxed">
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span> Company Employee Change Password</span>
                            </li>
                        </ul>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase">Company Employee Change Password</span>
                                        ...
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="fromchangepassword"  id="fromchangepassword" enctype="multipart/form-data" class="margin-bottom-40">
                                                <input type="hidden" value="companyemployeeChangePassword" name="action">
                                                <input type="hidden" name="companyemployeeid" id="companyemployeeid" value="<?php echo $row['companyemployeeid'];?>">
                                                <div class="form-body">
        ...
        <script type="text/javascript">
            ...
            function checkclose() {
                ...
                window.location.href = '<?php echo $web_url;?>admin/LocationEmployee.php';
