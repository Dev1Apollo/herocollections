                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span> Central Manager Change Password</span>
                            </li>
                        </ul>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase">Central Manager Change Password</span>
                                        ...
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="fromchangepassword"  id="fromchangepassword" enctype="multipart/form-data" class="margin-bottom-40">
                                                <input type="hidden" value="centralmanagerChangePassword" name="action">
                                                <input type="hidden" name="centralmanagerid" id="centralmanagerid" value="<?php echo $row['centralmanagerid'];?>">
                                                <div class="form-body">
