...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `colleted_application` " . $where . " and  is_assignto_am ='1' and am_accaptance='1'  ";
    $countstr = "SELECT count(*) as TotalRow FROM  `colleted_application` " . $where . " and  is_assignto_am ='1' and am_accaptance='1' ";
