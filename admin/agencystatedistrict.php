                                ...
                                <div class="portlet light ">
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                            <input type="hidden" value="agancystatedistrict" name="action" id="action">
                                            <input type="hidden" value="<?php echo $_REQUEST['token'] ?>" name="agencyid" id="agencyid">
...
//        }
        function getlocation() {
          ...
          //  var district = $('#district').val();
            var sId = $('#State').val();
            var urlp = '<?php echo $web_url; ?>admin/findmasteragencylocation.php?sId=' + sId + '&agencyid=' +agencyid;
            $.ajax({
                type: 'POST',
                url: urlp,
                success: function (data) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == 1)
                    {
                        ...
                        window.location.href = '<?php echo $web_url; ?>admin/agencystatedistrict.php?token=' + agencyid;
                    }
                }
