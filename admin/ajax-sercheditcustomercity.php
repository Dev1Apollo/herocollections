...
<!--                        <td></td>-->
                        ...
                        <td>                                                         
                            <a class="btn blue btn-sm" href="<?php echo $web_url; ?>admin/edit-serchcoustomercity.php?applicationid=<?php echo $rowfilter['applicationid']; ?>" title="Edit Case"><i class="fa fa-edit"></i></a> 
                        </td>
