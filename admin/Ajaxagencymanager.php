                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <div class="form-group form-md-line-input">
                                ...
                                <a  class="btn blue" href="<?php echo $web_url;?>admin/Editagencymanager.php?token=<?php echo $rowfilter['agencymanagerid']; ?>" title="Edit"><i class="fa fa-edit iconshowFirst"></i></i></a>
                                <a  class="btn blue" onClick="javascript: return deletedata('Delete', '<?php echo $rowfilter['agencymanagerid']; ?>');"   title="Delete"><i class="fa fa-trash-o iconshowFirst"></i></a>
                                 <a  class="btn blue" href="<?php echo $web_url;?>admin/agencyuserlocationassign.php?token=<?php echo $rowfilter['agencymanagerid']; ?>" title="Edit"><i class="fa fa-plus iconshowFirst"></i></i></a>
                            </div>
                        </td>
