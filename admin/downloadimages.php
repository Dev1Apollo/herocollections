...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Download Images </title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of Download Images</span>
                                        </div>                                      
                                    </div>
        ...
        <script type="text/javascript">
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url;?>admin/Ajaxdownloadimages.php",
