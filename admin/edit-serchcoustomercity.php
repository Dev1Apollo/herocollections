                                ...
                                <div class="portlet light ">
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                            <input type="hidden" value="EditCoustomercitycase" name="action" id="action">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <?php
                                                    $queryCom = "SELECT * FROM  location WHERE stateId='" . $row['stateid'] . "' ";
                                                    $resultCom = mysqli_query($dbconn, $queryCom);
                                                    echo '<select class="form-control" name="customer_city" id="customer_city" required="">';
                                                    echo "<option value='' >Select Customer City Name</option>";
                                                    while ($rowCom = mysqli_fetch_array($resultCom)) {
                                                        if($rowCom ['locationId'] == $row['customer_city_id']){
                                                             echo "<option value='" . $rowCom ['locationId'] . "' selected>" . $rowCom ['locationName'] . "</option>";
                                                        }else{
