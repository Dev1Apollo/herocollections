...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Branch </title>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase" id="editloction">Add Branch</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="AddLocation" name="action" id="action">
                                                 <input type="hidden" name="district" value="0">
                                                <div class="form-body">
                                                                                                       
                                                    <div class="form-group">
                                                        <label for="form_control_1">Branch Name</label>
                                                        <input name="Location" id="Location"  class="form-control"  placeholder="Enter Your Location Name" required="" type="text">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        echo '<select class="form-control" name="State" id="State" required=""  >';//onchange="finddistrict();"
...
//                                                        $results = mysqli_query($dbconn,$querys);
//                                                        echo '<select class="form-control" name="district" id="district" required="" >';
                                ...
                                <div class="col-md-8">
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                <i class="icon-settings font-red-sunglo"></i>
                                                <span class="caption-subject bold uppercase">List of Branch</span>
                                            </div>
                                            ...
                                            <div class="col-md-6 pull-right">
                                                <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                                    <div class="form-group col-md-9">
                                                        <input type="text" value="" name="Search_Txt" class="form-control" id="Search_Txt" placeholder="Search" required/>
...
//            }
           function finddistrict()
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        }else if (response == 2)
                        {
                            $('#loading').css("display", "none");
                            $("#Btnmybtn").attr('disabled', 'disabled');
                            alert('Location Edited Sucessfully.');
                            window.location.href = '';
                        } else
                        {
                            $('#loading').css("display", "none");
            ...
            function setEditdata(id)
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url;?>admin/querydata.php',
                    data: {action: "GetAdminLocation", ID: id},
                    success: function (response) {
                        document.getElementById("editloction").innerHTML = "EDIT Location";
                        $('#loading').css("display", "none");
                        var json = JSON.parse(response);
                        $('#Location').val(json.locationName);
                        $('#State').val(json.stateId);
                        $('#district').val(json.districtId);
                        $('#action').val('EditLocation');
                        $('<input>').attr('type', 'hidden').attr('name', 'locationId').attr('value', json.locationId).attr('id', 'locationId').appendTo('#frmparameter');
                    }
                });
            }
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url;?>admin/AjaxLocation.php",
         ...
         <script type="text/javascript">
            ...
            function checkb4submit()
            {
                ...
                var strURL = "locationReportDownload.php?Search_Txt=" + Search_Txt;
                //alert(strURL);           
