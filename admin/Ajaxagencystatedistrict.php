...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `agncylocation`  where agencyid= '" . $_REQUEST['agencyid'] . "' and isDelete='0'  and  istatus='1' order by  agncylocationid desc";
    $countstr = "SELECT count(*) as TotalRow FROM `agncylocation` agencyid= '" . $_REQUEST['agencyid'] . "' and isDelete='0' and  istatus='1' ";
            ...
            <tbody>
                ...
                while ($rowfilter = mysqli_fetch_array($resultfilter)) {
                    ...
                    <tr>
                        <td>
                            <?php
                            $agency = mysqli_fetch_array(mysqli_query($dbconn, "SELECT * FROM `agency` WHERE Agencyid = '" . $rowfilter['agencyid'] . "' and isDelete='0' and istatus='1' "));
                            $Location = mysqli_fetch_array(mysqli_query($dbconn, "SELECT * FROM `location` WHERE locationId = '" . $rowfilter['locationid'] . "' and isDelete='0' and istatus='1' "));
                        ...
                        <td>
                            <div class="form-group form-md-line-input "> 
                                <a  class="btn blue" onClick="javascript: return deletedata('Delete', '<?php echo $rowfilter['agncylocationid']; ?>');"   title="Delete"><i class="fa fa-trash-o iconshowFirst"></i></a>
                            </div>
                        </td>
...
if ($_REQUEST['action'] == 'Delete') {
    ...
    $delete=  mysqli_query($dbconn, "DELETE FROM `agncylocation` WHERE agncylocationid='".$_REQUEST['ID']."' ");
//    $data = array(
//        "isDelete" => '1',
