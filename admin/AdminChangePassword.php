...
$result = mysql_query("SELECT * FROM `adminemployee` WHERE `adminemployeeId`='" . $_REQUEST['token'] . "'");
    ...
    <body class="page-container-bg-solid page-boxed">
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo $web_url; ?>admin/AdminEmployee.php">List Of Employee</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                    ...
                                    <div class="portlet light ">
                                        ...
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="fromchangepassword"  id="fromchangepassword" enctype="multipart/form-data" class="margin-bottom-40">
                                                <input type="hidden" value="AdminCompanyChangePassword" name="action">
                                                <input type="hidden" name="adminemployeeId" id="adminemployeeId" value="<?php echo $row['adminemployeeId']; ?>">
                                                <div class="form-body">
        ...
        <script type="text/javascript">
            ...
            function checkclose() {
                ...
                window.location.href = '<?php echo $web_url; ?>admin/AdminEmployee.php';
