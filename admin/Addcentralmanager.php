...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Add Central Manager </title>
    ...
    <body class="page-container-bg-solid page-boxed">
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase"> Add Central Manager</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="Addcentralmanager" name="action" id="action">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input name="Mobile" id="Mobile"  class="form-control" placeholder="Enter Your Mobile No." pattern="[7-9]{1}[0-9]{9}" type="text">
                                                    </div>
                                                    <div class="form-group col-md-4">
        ...
        <script type="text/javascript">
            ...
            function chkLoginId(ID)
            {
                ...
                var urlp = '<?php echo $web_url; ?>admin/findcentralmanagerLoginID.php?ID=' + q;
                $.ajax({
                    type: 'POST',
                    url: urlp,
